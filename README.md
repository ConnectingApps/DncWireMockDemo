...
.NET 5 Support has been added but is (just like .NET 5 itself) in preview. An example of .NET 5 usage can be found here. This is how your `ItemGroup` element in your csproj should look like.
